                ...
                lines.forEach(l => {{
                    ...
                    if(inRules) {{
                        ...
                        if(ruleMatch) {{
                            ...
                            if(existing) {{
                                existing.focus = sanitize(existing.focus);
                                existing.note = content;
                            }} else {{
                                w.weeklyStructure.push({{ week: wkNum, focus: "Regola", note: content }});
                            }}
                        }}
                    }}
                }});
...
if __name__ == "__main__":
    ...
    print(f"Successo: Fix parsing Regole (W1, W2 con asterischi).")
